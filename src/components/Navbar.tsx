        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className="text-sm font-semibold bg-blue-600 text-white px-5 py-2.5 rounded-lg hover:bg-blue-700 transition-all shadow-md shadow-blue-200 hover:shadow-lg active:scale-95"
            >
              Request a Demo
            </button>
          </div>
      ...
      {isOpen && (
        <div id="mobile-navigation-menu" className="md:hidden bg-white border-t border-slate-100 shadow-xl absolute top-full left-0 right-0 p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
            <button
              onClick={() => { onLaunchPortal(); setIsOpen(false); }}
              className="flex items-center justify-center p-3 text-sm font-bold text-slate-700 bg-slate-50 hover:bg-slate-100 rounded-lg border border-slate-200"
            >
              Sign In
            </button>
            <button
              onClick={() => { onRequestDemo(); setIsOpen(false); }}
              className="p-3 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-md text-center"
            >
              Request Demo
            </button>
          </div>
